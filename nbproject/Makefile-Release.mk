...
${OBJECTDIR}/OSF_PlainAPI.o: OSF_PlainAPI.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OSF_PlainAPI.o OSF_PlainAPI.cpp

${OBJECTDIR}/OSF_Types.o: OSF_Types.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OSF_Types.o OSF_Types.cpp
...
${OBJECTDIR}/OSF_PlainAPI_nomain.o: ${OBJECTDIR}/OSF_PlainAPI.o OSF_PlainAPI.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OSF_PlainAPI_nomain.o OSF_PlainAPI.cpp;\
	else  \
...
${OBJECTDIR}/OSF_Types_nomain.o: ${OBJECTDIR}/OSF_Types.o OSF_Types.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OSF_Types_nomain.o OSF_Types.cpp;\
	else  \
