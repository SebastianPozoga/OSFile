...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/osfile

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/osfile: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/osfile ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/OSF_Directory.o: OSF_Directory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OSF_Directory.o OSF_Directory.cpp

${OBJECTDIR}/OSF_Exception.o: OSF_Exception.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OSF_Exception.o OSF_Exception.cpp

${OBJECTDIR}/OSF_File.o: OSF_File.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OSF_File.o OSF_File.cpp

${OBJECTDIR}/OSF_FileSystem.o: OSF_FileSystem.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OSF_FileSystem.o OSF_FileSystem.cpp

${OBJECTDIR}/OSF_PlainAPI.o: OSF_PlainAPI.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
...
${OBJECTDIR}/OSF_VHDD.o: OSF_VHDD.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OSF_VHDD.o OSF_VHDD.cpp
...
${TESTDIR}/tests/OSF_DirectoryTest_Basic.o: tests/OSF_DirectoryTest_Basic.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/OSF_DirectoryTest_Basic.o tests/OSF_DirectoryTest_Basic.cpp


${TESTDIR}/tests/OSF_DiskListTest_Basic.o: tests/OSF_DiskListTest_Basic.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/OSF_DiskListTest_Basic.o tests/OSF_DiskListTest_Basic.cpp


${TESTDIR}/tests/OSF_FileSystemTest_Basic.o: tests/OSF_FileSystemTest_Basic.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/OSF_FileSystemTest_Basic.o tests/OSF_FileSystemTest_Basic.cpp


${TESTDIR}/tests/OSF_FileTest_Basic.o: tests/OSF_FileTest_Basic.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/OSF_FileTest_Basic.o tests/OSF_FileTest_Basic.cpp


${TESTDIR}/tests/OSF_PlainAPITest_Basic.o: tests/OSF_PlainAPITest_Basic.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/OSF_PlainAPITest_Basic.o tests/OSF_PlainAPITest_Basic.cpp


${TESTDIR}/tests/OSF_VHDD_Basic.o: tests/OSF_VHDD_Basic.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/OSF_VHDD_Basic.o tests/OSF_VHDD_Basic.cpp
...
${OBJECTDIR}/OSF_Directory_nomain.o: ${OBJECTDIR}/OSF_Directory.o OSF_Directory.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OSF_Directory_nomain.o OSF_Directory.cpp;\
	else  \
...
${OBJECTDIR}/OSF_Exception_nomain.o: ${OBJECTDIR}/OSF_Exception.o OSF_Exception.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OSF_Exception_nomain.o OSF_Exception.cpp;\
	else  \
...
${OBJECTDIR}/OSF_File_nomain.o: ${OBJECTDIR}/OSF_File.o OSF_File.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OSF_File_nomain.o OSF_File.cpp;\
	else  \
...
${OBJECTDIR}/OSF_FileSystem_nomain.o: ${OBJECTDIR}/OSF_FileSystem.o OSF_FileSystem.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OSF_FileSystem_nomain.o OSF_FileSystem.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/OSF_FileSystem.o ${OBJECTDIR}/OSF_FileSystem_nomain.o;\
	fi

${OBJECTDIR}/OSF_PlainAPI_nomain.o: ${OBJECTDIR}/OSF_PlainAPI.o OSF_PlainAPI.cpp 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/OSF_PlainAPI.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
...
${OBJECTDIR}/OSF_VHDD_nomain.o: ${OBJECTDIR}/OSF_VHDD.o OSF_VHDD.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OSF_VHDD_nomain.o OSF_VHDD.cpp;\
	else  \
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/osfile
